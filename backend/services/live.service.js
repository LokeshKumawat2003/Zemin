...
class LiveService {
  ...
  mapRoomSummary(r, giftMap = {}, creatorStats = {}) {
    ...
    return {
      ...
      playbackType: r.playbackType || 'livekit',
      playbackUrl: r.playbackType === 'video' ? r.playbackUrl : undefined,
      ...
      status: r.status,
      viewerCount: currentViewers + (r.fakeViewerIds?.length || 0),
      followerCount,
      totalViews,
  ...
  async joinRoom(userId, roomId) {
    ...
    const response = {
      ...
      livekitRoom: room.livekitRoom,
      livekitEnabled: livekitService.isReady(),
      playbackType: room.playbackType || 'livekit',
      playbackUrl: room.playbackType === 'video' ? room.playbackUrl : undefined,
      host: {
      ...
      viewerCount: room.stats.currentViewers + (room.fakeViewerIds?.length || 0),
      title: room.title,
